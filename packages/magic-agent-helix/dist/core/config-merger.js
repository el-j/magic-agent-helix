...
export function loadUserConfig() {
    ...
    try {
        ...
        console.error(pc.red(`❌ Error parsing ${CONFIG_FILENAME}: ${e.message}`));
        console.warn(pc.yellow("  Please fix the JSON or remove the file. Using built-in conventions only."));
        return {};
    }
}
/**
