...
export class PythonPlugin implements DetectionPlugin {
	...
	readonly description = "Detects Python projects and provides Python-specific instructions";
	...
	detect(context: DetectionContext): DetectionResult {
		...
		const detected = hasPyprojectToml || hasRequirementsTxt || hasSetupPy || hasPipfile || hasPyFiles;
